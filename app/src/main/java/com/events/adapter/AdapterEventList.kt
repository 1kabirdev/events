...
class AdapterEventList(private var events: ArrayList<ListEvents>) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): AdapterEventList.ViewHolder {
        val view = LayoutInflater
            .from(parent.context)
            .inflate(R.layout.item_list_events, parent, false)
    ...
    inner class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        private var closeEvents: TextView = view.findViewById(R.id.closeEvents)
        ...
        fun bindLoad(holder: ViewHolder, eventsList: ListEvents) {
            ...
            if (eventsList.getDataE() < getInitialDate() || eventsList.getTimeE() < getInitialTime()) {
                holder.closeEvents.text = "Не активен"
            } else {
                holder.closeEvents.text = "Активен"
                holder.closeEvents.background =
